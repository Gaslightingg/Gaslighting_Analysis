...
- Рекомендуется Python **3.11** или **3.12** (на этих версиях стек зависимостей наиболее стабилен).
...
- Перед запуском Optuna есть guard по данным (`MIN_BARS`, по умолчанию 150): если баров мало,
  trials не стартуют.
